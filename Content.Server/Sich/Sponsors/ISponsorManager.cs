...
{
    // --- Базовий життєвий цикл (інтеграція з UserDbDataManager) ---
    void Init();
    ...
    // --- Отримання "сирих" даних (для відправки в UI або специфічних завдань) ---
    ...
    // --- Хелпери-абстракції (Фасад для ChatSystem, GhostSystem, LoadoutSystem) ---
    /// <summary>
